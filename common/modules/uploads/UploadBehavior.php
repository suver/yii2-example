...
namespace common\modules\uploads\behaviors;

use common\modules\uploads\File;
use common\modules\uploads\ImageFile;
use common\modules\uploads\IncorrectFile;
use common\modules\uploads\models\Uploads;
